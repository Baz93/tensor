...
template<typename T> class tensor_container : private vector<T> {
public:
...
template<> class tensor_container<bool> : private vector<char> {
public:
    ...
    bool *data() {
        return reinterpret_cast<bool *>(vector<char>::data());
    }
};
